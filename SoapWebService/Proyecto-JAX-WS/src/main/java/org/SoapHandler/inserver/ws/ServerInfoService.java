//este cambio lo hice por q tengo el cliente y el servidor en el mismo proyecto deberian ser dos proyectos diferentes
//estos archivos generados por wsimport
 ...
 * 
 */
@WebServiceClient(name = "ServerInfoService", targetNamespace = "http://service.ws.inserver.SoapHandler.org/", wsdlLocation = "http://localhost:8888/ws/server?wsdl")
@HandlerChain(file="handler-chainClient.xml")
    ...
    extends Service
{
    ...
    private final static QName SERVERINFOSERVICE_QNAME = new QName("http://service.ws.inserver.SoapHandler.org/", "ServerInfoService");
    ...
    public ServerInfo getServerInfoPort() {
        return super.getPort(new QName("http://service.ws.inserver.SoapHandler.org/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ws.inserver.SoapHandler.org/", "ServerInfoPort"), ServerInfo.class, features);
    }
