 ...
 * generated in the org.soaphandler.inserver.ws.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerNameResponse_QNAME = new QName("http://service.ws.inserver.SoapHandler.org/", "getServerNameResponse");
    private final static QName _GetServerName_QNAME = new QName("http://service.ws.inserver.SoapHandler.org/", "getServerName");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.soaphandler.inserver.ws.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.inserver.SoapHandler.org/", name = "getServerNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.inserver.SoapHandler.org/", name = "getServerName")
